...
# @Description - Calculates total freshwater consumption for the year 2010 from Huang et al. (2018) across all sectors, using the median agricultural estimate (of 4). 
################################################################################
...
# NOTE: While only the process for deriving the consumption data is shown below, the process is repeated for withdrawal data with no other changes made to the code.
