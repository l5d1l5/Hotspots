...
# @Description - Harmonize raw input data to 0.5 degree resolution.
################################################################################
...
# GRACE TWS, consumption & withdrawal rates,population data are directly available in 0.5d resolution
# IWRM data is handled in script 5_'...'.R directly.
# Streamflow alternatives are prepared in a separate script: Preprocessing > 3_'...'.R

# Convert Rodell et al. source data in .csv to raster ----
