...
library(raster); library(dplyr); library(magrittr); library(here)
a <- 6378137.0  # Semi-major Axis 
b <- 6356752.3142 # Semi-minor Axis 
e2 <- 0.00669437999014 # First Eccentricity Squared 
pi <- 3.141592653589793238462643383 # too many digits? lol... 

# state desired resolution below in decimal degrees
RES <- 0.5
